...
export default function PrivacyPolicy() {
  return (
    <Card>
      ...
      <ul className='pl-8 list-disc'>
        ...
        <li>
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to My Reading Reviews.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong className='font-semibold'>Website</strong> refers to My
            Reading Reviews, accessible from{' '}
            <a
              href='https://my-reading-reviews.vercel.app/'
              rel='external nofollow noopener noreferrer'
              target='_blank'
            >
              https://my-reading-reviews.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <h3 className='text-xl underline'>Personal Data</h3>
      <p>
      ...
      <h3 className='text-xl underline'>Usage Data</h3>
      ...
      <h3 className='text-xl underline'>Tracking Technologies and Cookies</h3>
      <p>
      ...
      <h3 className='text-xl underline'>Business Transactions</h3>
      <p>
      ...
      <h3 className='text-xl underline'>Law enforcement</h3>
      <p>
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h3 className='text-xl underline'>Other legal requirements</h3>
      <p>
